pipeline {
    ...
    environment {
        GIT_REPO_URL = 'https://github.com/harishb2907/pipeline.git'
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/harishb2907/pipeline.git']]])
                }
            }
        }
        ...
        stage('Deploy to Nginx') {
            steps {
                script {
                    ...
                    bat 'xcopy /y "C:\\Users\\vigne\\OneDrive\\Desktop\\abc" "%NGINX_PATH%"'
                }
            }
        }
    }
